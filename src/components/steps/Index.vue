<template>
  <div class="steps-wrapper">
    <div class="steps-list" v-for="(s, i) in steps" :key="i">
      <div class="current-index" :class="currentIndex === i || currentIndex >= i ? 'active': ''">{{ i + 1 }}</div>
...
export default defineComponent({
  ...
  setup(props) {
    const { currentIndex, steps, styleWith } = props;
